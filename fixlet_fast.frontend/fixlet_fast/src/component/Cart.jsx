  ...
  return (
    <div className='flex justify-between border-2 px-5 py-2 rounded'>
        ...
        <div>
            ...
            <button  onClick={() => onClickAdd(serviceId, subServiceId,subservice,price)} className="text-sm font-semibold text-orange-500 hover:bg-orange-300 hover:text-white px-2">+</button>

                    <span className="text-sm font-semibold text-orange-500">{quantity}</span>

                    <button  onClick={() => onClickSubtract(serviceId, subServiceId,subservice,price)} className="text-sm font-semibold text-orange-500 px-2 hover:bg-orange-300 hover:text-white">-</button>
                    </div>
        </div>
    </div>

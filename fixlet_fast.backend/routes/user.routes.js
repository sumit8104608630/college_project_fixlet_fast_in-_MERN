...
const{userRegister,userLogin,userLogout,userInfo,generateOtp,verify_otp,saveUserAddress,saveUserCustomAddress}=require("../controllers/user.controller.js")
...
userRoute.post("/change_password",checkAuthenticationCookie("accessToken"))
